...
/* 
1- La funcion devuelve un listado de errores según las comprobaciones que hace sobre el
objeto.
2- Si el nombre no es un texto y tiene menos de 3 caracteres sumar el error: "El nombre
debe tener al menos 3 caracteres."
3- Si la contraseña tiene menos de 6 caracteres, sin contar espacios al principio, en el
medio o final, sumar el error: "La contraseña debe tener al menos 6 caracteres, entre
letras y símbolos."
4- Si el telefono tiene menos de 10 números, sumar el error: "No es un teléfono válido."
5- Si la lista de hobbies tiene más de 4 items, sumar el error: "Sólo es posible seleccionar
4 hobbies."
...
function validarInformacion(usuario) {
  ...
  if ( /^[A-Z]+$/i.test(usuario.nombre) === false || usuario.nombre.length < 3 ) {
    errores.push('El nombre debe tener al menos 3 caracteres.')
  }
  
  let passSinEspacios = usuario.password.replaceAll(' ', '')
  if (passSinEspacios.length < 6) {
